...
/**
 * @file
 * Documents hooks invoked by the Commerce Paymetric Tokenization module.
 */


/**
 * Allows modules to alter the parameters of an AIM API request immediately
 * prior to its submission to Paymetric Tokenization.
 *
 * @param $nvp
 ...
 */
function hook_commerce_paymetric_aim_request_alter($nvp, $payment_method) {
  // No example.
}

/**
 * Allows modules to alter the SimpleXMLElement object used to construct a CIM
 * API request immediately prior to its submission to Paymetric Tokenization.
 *
 ...
 */
function hook_commerce_paymetric_cim_request_alter($api_request_element, $payment_method, $request_type) {
  // No example.
}
